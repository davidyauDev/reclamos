...
<body
    ...
    <!-- Nota de depuración (no afecta a la app):
             1) Para listar rutas: php artisan route:list
             2) Si no ves cambios: php artisan route:clear && php artisan config:clear && php artisan cache:clear
             3) Verifica sintaxis del archivo: php -l routes/api.php
             4) Revisa errores en storage/logs/laravel.log
             5) Ruta de prueba añadida: GET /api/__routes_alive (debe devolver {"routes_file":"loaded",...})
        -->
